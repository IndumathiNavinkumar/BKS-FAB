                    ...
                    <div className="row align-items-center  flex-column-reverse flex-lg-row">
                        <div className="col-lg-6 col-md-12 workwear-content">
                            <div className="about-content p-0">
                                ...
                                BKS systems of manufacturing supported with, the latest software,ie  SAP S4 HANA FMS  for  consistently producing the  high-quality fabrics,  Hospitality linens and apparels. 
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="about-image">
                                <img src="/images/Why-bks/erp.jpg" alt="image" style={{width:"100%"}}/>
