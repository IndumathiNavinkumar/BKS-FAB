                ...
                <div className="row m-0  flex-column-reverse flex-lg-row" style={{padding:"50px 0px"}}>
                    ...
                    <div className="col-lg-6 p-0" style={{ display: "flex", alignContent: "center" }}>
                        <div className="webinar-content" >
                            ...
                            At BKS,we explore the strength of Indian spinning in sourcing the finest Cotton, Polycotton, Polyester, Linen and Viscose yarns in various counts ranging from 4’s to 100’s, from modern spinning mills & across globe.
                            </p>
                            <p style={{fontSize:"16px"}}>
