            ...
            >
              <div className="single-footer-widget">
                <div className="logo">
                  ...
                  <p style={{paddingRight:'56px'}}>
                  BKS has a modern plant in Tirupur that utilizes green energy and houses cutting-edge weaving, processing and finishing machinery, integrating the latest technologies to ensure the best product outcomes. 
                  </p>
                </div>
            ...
            >
              <div className="single-footer-widget">
                ...
                <ul className="footer-services-list">
                  ...
                  <li>
                  <Link href="/hospitality-linen-gallery/" >Gallery - Hospitality Linen</Link>
                  </li>
                 
                  {/* <li>
                  <Link href="/promotional-bags-gallery/" >Gallery - Promotional Bags</Link>
                  </li> */}
                {/*  <li>
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-6 col-sm-6">
                <p>Copyright {currentYear} @ BKS. Concept by <a href="https://irepute.in/" target="_blank" className="repute"> repute</a> </p>
              </div>
